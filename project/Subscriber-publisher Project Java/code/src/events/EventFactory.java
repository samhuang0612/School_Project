...
public class EventFactory {
	...
	public static AbstractEvent createEvent(EventType eventType, int eventPublisherId, EventMessage payload) {
		long ID =EventIDMaker.getNewEventID();
			switch(eventType) {
				case food : 
					return new EventTypeFood(ID, eventPublisherId, payload);
				case transport :
					return  new EventTypeTransport(ID, eventPublisherId, payload);
				default :
					return  new EventTypeUnset(ID, eventPublisherId, payload);
			}
	}
}
